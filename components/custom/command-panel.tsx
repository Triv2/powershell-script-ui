  ...
  return (
    <div>
      ...
      <Tabs defaultValue="all">
        ...
        <TabsContent value="all" className="max-h-[400px] overflow-y-auto mt-4">
        ...
        <TabsContent value="favorites" className="max-h-[400px] overflow-y-auto mt-4">
          {favorites.length === 0 ? (
        ...
        <TabsContent value="recent" className="max-h-[400px] overflow-y-auto mt-4">
